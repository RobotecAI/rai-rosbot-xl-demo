...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('rosbot_xl_demo')
    ...
    declare_scene_config_file_cmd = DeclareLaunchArgument(
        'scene_config',
        default_value=os.path.join(bringup_dir, 'config', 'one_rosbot.yaml'),
        description='Full path to the scene config file to use',
    )
            ...
            [
                ...
                Node(
                    ...
                    parameters= [
                        ...
                        {"robot_initial_position": [init_pose['x'], init_pose['y'], init_pose['z']]}
                    ]
                ),
            ]
        )
